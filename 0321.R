...
##tapply()
tapply(NBA1415$Name,NBA1415$Team,length) #一隊裡面有幾個球員
tapply(NBA1415$TotalPoints,NBA1415$Team,max) #一隊裡總得分數最多是幾分 (向量,分類依據,函數)
tapply(NBA1415$TotalPoints,NBA1415$Team,mean) #每隊的平均得分數
tapply(NBA1415$TotalPoints,NBA1415$Team,range) #每隊的得分範圍:最小跟最大
