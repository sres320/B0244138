...
weekdays(x1)
months(x1)
seq(Sys.Date(), by="1 months", length.out=2)
seq(as.Date("2016-01-31"), by="1 months", length.out=1)
...
paste(c("Hello", "World"), sep='',collapse = '') #collapse連接向量
#字串切割
